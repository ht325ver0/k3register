...
mixin _$Product {
  ...
  int get quantity =>
      throw _privateConstructorUsedError; // IconDataはJSONにシリアライズできないため、変換対象から除外します
...
// IconDataはJSONにシリアライズできないため、変換対象から除外します
  ...
  @override
  String toString() {
    return 'Product(id: $id, name: $name, price: $price, taste: $taste, quantity: $quantity, icon: $icon)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, price, taste, quantity, icon);
...
abstract class _Product extends Product {
  const factory _Product(
      ...
      @JsonKey(includeFromJson: false, includeToJson: false)
      final IconData? icon}) = _$ProductImpl;
  ...
  Taste? get taste;
  @override
  int get quantity; // IconDataはJSONにシリアライズできないため、変換対象から除外します
  @override
  @JsonKey(includeFromJson: false, includeToJson: false)
  IconData? get icon;
